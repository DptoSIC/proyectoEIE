...
public TablaProyectos(Collection<Proyecto> proyectos) {
		...
		int indiceLocal = modelo.findColumn("Código");
		getColumnModel().getColumn(indiceLocal).setPreferredWidth(5);
		getColumnModel().getColumn(modelo.findColumn("Titulo")).setPreferredWidth(5);
		getColumnModel().getColumn(modelo.findColumn("Descripcion Corta")).setPreferredWidth(50);
